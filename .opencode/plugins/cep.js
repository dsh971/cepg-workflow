...
// Note: this generates one command per skill file, including cepg-check-debug
// and cepg-check-review separately — it has no concept of commands/cepg-check.md's
// single wrapper routing between them. That routing is Claude Code/Codex-specific;
